...
data(pcaPhoneTestData, package = "flipU")
...
testthat::expect_less_than(
    FactorAnalysis(data = test.data.2,
                   weights = test.weight,
                   n.factors = 7)$loadings[4,3] -0.11674422568134, 1e-11
)
...
testthat::expect_less_than(mf2$loadings[10,1] - 0.85516, 2e-5)
# Loading for FEMIN in component 3
testthat::expect_less_than(mf2$loadings[18,3] - 0.56029, 2e-5)
